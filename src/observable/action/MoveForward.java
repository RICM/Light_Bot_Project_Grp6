...
public class MoveForward implements int_Action, int_Observable{
	...
	public void execute(abstr_Robot r) throws MouvementEx, UnreachableCase{
		...
		if (! this.isPossible(r,c_prime)){
			...
			System.out.println("possible d'avancer");
			System.out.println("le robot : "+r);
			System.out.println("va notifier le controller");
	...
	public int_Action Clone() {
		int_Action temp = new MoveForward(this.getColor());
		return temp;
	}
}
